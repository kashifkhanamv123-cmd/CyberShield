...
document.addEventListener('DOMContentLoaded', function() {
    ...
    chatForm.addEventListener('submit', function(e) {
        ...
        // API Call - Dynamic Path Detection
        const formData = new FormData();
        formData.append('message', msg);

        const basePath = document.getElementById('ai-chatbot-container').getAttribute('data-base-path') || '';
        const chatPath = basePath + 'process_chat.php';
        ...
        .catch(err => {
            document.getElementById(thinkingId).remove();
            appendMessage('ai', 'Fatal: Connection to AI core lost.');
        });
    });
